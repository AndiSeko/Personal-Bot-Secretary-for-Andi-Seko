...
ЗАПРЕЩЕНО: <ol>, <ul>, <li>, <p>, <div>, <h1> и т.п. — вместо списков используй • или — и обычный перенос строки (Enter), вместо заголовков — <b>Заголовок</b>. НИКОГДА не пиши буквально \n — делай реальный перенос строки.
